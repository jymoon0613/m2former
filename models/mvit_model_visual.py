...
class CrossAttention(nn.Module):
    ...
    def forward(self, hidden_states1, hidden_states2, hidden_states3, hidden_states4):
        ...
        return attention_output1, attention_output2, attention_output3, attention_output4, weight1, weight2, weight3, weight4
...
class SpatialCrossAttention(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        x1, x2, x3, x4, weight1, weight2, weight3, weight4 = self.attn(x1, x2, x3, x4)
        x1 = x1 + h1
        x2 = x2 + h2
        x3 = x3 + h3
        x4 = x4 + h4
        ...
        x3 = x3 + h3
        x4 = x4 + h4
        return x1, x2, x3, x4, weight1, weight2, weight3, weight4
...
class PatchSelection(nn.Module):
    ...
    def forward(self, x, token):
        ...
        ids_restore = torch.argsort(inds, dim=1)
...
class MViT(nn.Module):
    ...
    def forward_features(self, x):
        ...
        x_masked1, inx1, inr1 = self.part_select1(x_mer1, token1)
        x_masked2, inx2, inr2 = self.part_select2(x_mer2, token2)
        x_masked3, inx3, inr3 = self.part_select3(x_mer3, token3)
        x_masked4, inx4, inr4 = self.part_select4(x_mer4, token4)
        ...
        out1, out2, out3, out4, weight1, weight2, weight3, weight4 = self.sca(out1, out2, out3, out4)
        
        weights.append(weight1), weights.append(weight2), weights.append(weight3), weights.append(weight4)
        ...
        return outs, inter, inds, inrs, weights
    
    def forward(self, x, labels=None):
        outs, inter, inds, inrs, weights = self.forward_features(x)
        ...
        if labels is not None:
            ...
            return inter, inds, inrs, weights
